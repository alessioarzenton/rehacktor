...
export default function Game() {
  ...
  useEffect(() => {
    fetch(`${api_urls.games}/api/games/${slug}?&key=${api_secrets.games}`)
      ...
      .then((id) => {
        fetch(`${api_urls.backend}/api/users/room/roomsByGame?game_id=${id}`)
          .then((response) => response.json())
          .then((data) => {
            console.log(data);
            setStreamers(data);
            ...
            <div className="row my-5">
                ...
                <div className="mb-3">
                  ...
                  <p className="ms-3 mb-0">
                    ...
                    <a
                      ...
                      href={game.website}
                    >
                      Go to <i className="fal fa-chevron-right"></i>
                    </a>
                  </p>
                </div>
                <div className="mb-3">
                  ...
                  return (
                    <div key={el.id} className="mb-3">
                      <p className="small mb-0">
                        ...
                        <span className="float-end">{el.percent}%</span>
                      </p>
                    </div>
                  );
                })}
              ...
              <div className="col-12 col-md-4 col-lg-3">
                {user ? (
                  ...
                  >
                    <i className="fal fa-chevron-right" /> Start Your Stream
                  </Link>
                ) : (
